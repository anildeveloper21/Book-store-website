...
const Navbar = () => {
    ...
    const [theme, setTheme] = useState(localStorage.getItem("theme")?localStorage.getItem("theme") : "loght");
                ...
                <div className='navbar-end space-x-3'>
                    ...
                    <div className='hidden md:block'>
                        <label className="flex items-center gap-2">
                            <input type="text" className="outline-none border-2 rounded-md px-4 py-1 grow" placeholder="Search" />
                    ...
                    <div className="">
                        <a className="bg-black text-white px-4 py-2 cursor-pointer rounded-md"
